...
static inline int MPIDI_POSIX_mpi_init_hook(int rank, int size)
{
    ...
    gettimeofday(&tv_stop, NULL);
    printf("shm_posix_init-shm_seg_commit %8.8f\n", (tv_stop.tv_sec - tv_start.tv_sec) + (tv_stop.tv_usec - tv_start.tv_usec)/1000000.0);
    gettimeofday(&tv_start, NULL);
    ...
    gettimeofday(&tv_stop, NULL);
    printf("shm_posix_init-shm_barrier %8.8f\n", (tv_stop.tv_sec - tv_start.tv_sec) + (tv_stop.tv_usec - tv_start.tv_usec)/1000000.0);
    gettimeofday(&tv_start, NULL);
    ...
    gettimeofday(&tv_stop, NULL);
    printf("shm_posix_init-shm_barrier2 %8.8f\n", (tv_stop.tv_sec - tv_start.tv_sec) + (tv_stop.tv_usec - tv_start.tv_usec)/1000000.0);
    gettimeofday(&tv_start, NULL);
...
#undef MPIDI_POSIX_MAILBOX_INDEX
    ...
    MPIR_CHKPMEM_COMMIT();
    gettimeofday(&tv_stop, NULL);
    printf("shm_posix_init-epilogue %8.8f\n", (tv_stop.tv_sec - tv_start.tv_sec) + (tv_stop.tv_usec - tv_start.tv_usec)/1000000.0);
